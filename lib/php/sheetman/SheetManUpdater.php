...
final class SheetManUpdater
{
    ...
    public static function update(
        ...
        try {
            ...
            $log(\sprintf('sheetman: %d file(s) to fetch, %d to remove.',
            ...
            $log(\sprintf('sheetman: updated. %d fetched, %d removed.',
    ...
    private static function download(string $url, UpdateOptions $options, callable $log): string
    {
        ...
        for ($attempt = 1; ; $attempt++) {
            try {
                ...
                $log(\sprintf('sheetman: %s Retrying in %.1fs (%d of %d).',
