...
#include <string.h>
static bool Rescue_BGMSoundTableParse(Rescue_BGMSoundTableTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_BGMSoundTableRecord_t*)sm_arena_alloc(
  ...
  for (row = 0; row < table->count; ++row) {
    Rescue_BGMSoundTableRecord_t* record = &table->records[row];
  ...
  for (at = 0; at < column_count && !sm_failed(reader); ++at) {
    ...
    case 1:
      (void)sm_check_column(reader, column, "BGMSoundTable.Id", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 2:
      (void)sm_check_column(reader, column, "BGMSoundTable.Name", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 3:
      (void)sm_check_column(reader, column, "BGMSoundTable.Path", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 4:
      (void)sm_check_column(reader, column, "BGMSoundTable.Loop", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_BOOL));
    ...
    case 5:
      (void)sm_check_column(reader, column, "BGMSoundTable.FadeTime", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_F32));
    ...
    case 6:
      (void)sm_check_column(reader, column, "BGMSoundTable.Description", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
...
bool Rescue_BGMSoundTableLoad(Rescue_BGMSoundTableTable_t* table, const char* filename,
  ...
  Rescue_BGMSoundTableTable_t loaded;
