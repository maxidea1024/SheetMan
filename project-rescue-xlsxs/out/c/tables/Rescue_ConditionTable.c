...
#include <string.h>
static bool Rescue_ConditionTableParse(Rescue_ConditionTableTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_ConditionTableRecord_t*)sm_arena_alloc(
  ...
  for (row = 0; row < table->count; ++row) {
    Rescue_ConditionTableRecord_t* record = &table->records[row];
  ...
  for (at = 0; at < column_count && !sm_failed(reader); ++at) {
    ...
    case 1:
      (void)sm_check_column(reader, column, "ConditionTable.Id", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 2:
      (void)sm_check_column(reader, column, "ConditionTable.Name", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 3:
      (void)sm_check_column(reader, column, "ConditionTable.ConditionTargetType", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 4:
      (void)sm_check_column(reader, column, "ConditionTable.ConditionTargetValue", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 5:
      (void)sm_check_column(reader, column, "ConditionTable.ConditionType", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 6:
      (void)sm_check_column(reader, column, "ConditionTable.ConditionValue", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
...
bool Rescue_ConditionTableLoad(Rescue_ConditionTableTable_t* table, const char* filename,
  ...
  Rescue_ConditionTableTable_t loaded;
