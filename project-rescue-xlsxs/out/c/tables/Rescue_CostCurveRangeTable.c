...
#include <string.h>
static bool Rescue_CostCurveRangeTableParse(Rescue_CostCurveRangeTableTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_CostCurveRangeTableRecord_t*)sm_arena_alloc(
  ...
  for (at = 0; at < column_count && !sm_failed(reader); ++at) {
    ...
    case 1:
      (void)sm_check_column(reader, column, "CostCurveRangeTable.Id", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));


      for (row = 0; row < table->count && !sm_failed(reader); ++row) {
        Rescue_CostCurveRangeTableRecord_t* record = &table->records[row];
    ...
    case 2:
      (void)sm_check_column(reader, column, "CostCurveRangeTable.GrowthType", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 3:
      (void)sm_check_column(reader, column, "CostCurveRangeTable.RangeIndex", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 4:
      (void)sm_check_column(reader, column, "CostCurveRangeTable.StartStep", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 5:
      (void)sm_check_column(reader, column, "CostCurveRangeTable.EndStep", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 6:
      (void)sm_check_column(reader, column, "CostCurveRangeTable.AddMultiplier", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_F32));
...
bool Rescue_CostCurveRangeTableLoad(Rescue_CostCurveRangeTableTable_t* table, const char* filename,
  ...
  Rescue_CostCurveRangeTableTable_t loaded;
