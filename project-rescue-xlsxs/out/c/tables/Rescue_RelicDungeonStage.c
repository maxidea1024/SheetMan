...
#include <string.h>
static bool Rescue_RelicDungeonStageParse(Rescue_RelicDungeonStageTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_RelicDungeonStageRecord_t*)sm_arena_alloc(
  ...
  for (at = 0; at < column_count && !sm_failed(reader); ++at) {
    ...
    case 7:
      (void)sm_check_column(reader, column, "RelicDungeonStage.SpawnIds", SM_KIND_VAR_ARRAY, 0, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 8:
      (void)sm_check_column(reader, column, "RelicDungeonStage.BossID", SM_KIND_VAR_ARRAY, 0, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 11:
      (void)sm_check_column(reader, column, "RelicDungeonStage.SpawnNextTime", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_F32));

      (void)sm_cursor_init(&cursor, reader, column, table->count, "RelicDungeonStage.SpawnNextTime");
    ...
    case 15:
      (void)sm_check_column(reader, column, "RelicDungeonStage.AtkUpPercent", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_F32));

      (void)sm_cursor_init(&cursor, reader, column, table->count, "RelicDungeonStage.AtkUpPercent");
    ...
    case 16:
      (void)sm_check_column(reader, column, "RelicDungeonStage.DefUpPercent", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_F32));

      (void)sm_cursor_init(&cursor, reader, column, table->count, "RelicDungeonStage.DefUpPercent");
    ...
    case 17:
      (void)sm_check_column(reader, column, "RelicDungeonStage.MHPUpPercent", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_F32));

      (void)sm_cursor_init(&cursor, reader, column, table->count, "RelicDungeonStage.MHPUpPercent");
...
bool Rescue_RelicDungeonStageLoad(Rescue_RelicDungeonStageTable_t* table, const char* filename,
  ...
  Rescue_RelicDungeonStageTable_t loaded;
...
void Rescue_RelicDungeonStageFree(Rescue_RelicDungeonStageTable_t* table) {
  sm_arena_free(&table->arena);

  memset(table, 0, sizeof *table);
}

const Rescue_RelicDungeonStageRecord_t* Rescue_RelicDungeonStageFindById(
  const Rescue_RelicDungeonStageTable_t* table, int32_t key) {
  int32_t position = sm_index_find(table->by_id, table->count, key);

  return position < 0 ? NULL : &table->records[position];
}

bool Rescue_RelicDungeonStageContainsId(
  const Rescue_RelicDungeonStageTable_t* table, int32_t key) {
