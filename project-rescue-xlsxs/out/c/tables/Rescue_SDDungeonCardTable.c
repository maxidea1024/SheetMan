...
#include <string.h>
static bool Rescue_SDDungeonCardTableParse(Rescue_SDDungeonCardTableTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_SDDungeonCardTableRecord_t*)sm_arena_alloc(
  ...
  for (row = 0; row < table->count; ++row) {
    Rescue_SDDungeonCardTableRecord_t* record = &table->records[row];

    record->name = "";

    record->sd_dun_name = "";

    record->stat_icon_path = "";
  ...
  for (at = 0; at < column_count && !sm_failed(reader); ++at) {
    ...
    case 1:
      (void)sm_check_column(reader, column, "SDDungeonCardTable.Id", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 2:
      (void)sm_check_column(reader, column, "SDDungeonCardTable.Name", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 3:
      (void)sm_check_column(reader, column, "SDDungeonCardTable.SDDunName", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 4:
      (void)sm_check_column(reader, column, "SDDungeonCardTable.SDCardType", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 5:
      (void)sm_check_column(reader, column, "SDDungeonCardTable.CardCount", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 6:
      (void)sm_check_column(reader, column, "SDDungeonCardTable.StatIconPath", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 7:
      (void)sm_check_column(reader, column, "SDDungeonCardTable.IconPath", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
...
bool Rescue_SDDungeonCardTableLoad(Rescue_SDDungeonCardTableTable_t* table, const char* filename,
  ...
  Rescue_SDDungeonCardTableTable_t loaded;
