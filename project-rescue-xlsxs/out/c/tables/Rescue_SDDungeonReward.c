...
#include <string.h>
static bool Rescue_SDDungeonRewardParse(Rescue_SDDungeonRewardTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_SDDungeonRewardRecord_t*)sm_arena_alloc(
...
bool Rescue_SDDungeonRewardLoad(Rescue_SDDungeonRewardTable_t* table, const char* filename,
  ...
  Rescue_SDDungeonRewardTable_t loaded;
