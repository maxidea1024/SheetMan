...
#include <string.h>
static bool Rescue_SFXSoundParse(Rescue_SFXSoundTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_SFXSoundRecord_t*)sm_arena_alloc(
