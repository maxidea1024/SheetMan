...
#include <string.h>
static bool Rescue_SFXSoundTableParse(Rescue_SFXSoundTableTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_SFXSoundTableRecord_t*)sm_arena_alloc(
  ...
  for (row = 0; row < table->count; ++row) {
    Rescue_SFXSoundTableRecord_t* record = &table->records[row];

    record->name = "";

    record->path = "";

    record->preload_group = "";
  ...
  for (at = 0; at < column_count && !sm_failed(reader); ++at) {
    ...
    case 1:
      (void)sm_check_column(reader, column, "SFXSoundTable.Id", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 2:
      (void)sm_check_column(reader, column, "SFXSoundTable.Name", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 3:
      (void)sm_check_column(reader, column, "SFXSoundTable.Category", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 4:
      (void)sm_check_column(reader, column, "SFXSoundTable.Path", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 5:
      (void)sm_check_column(reader, column, "SFXSoundTable.PreloadGroup", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
    ...
    case 6:
      (void)sm_check_column(reader, column, "SFXSoundTable.Description", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_STRING));
...
bool Rescue_SFXSoundTableLoad(Rescue_SFXSoundTableTable_t* table, const char* filename,
  ...
  Rescue_SFXSoundTableTable_t loaded;
