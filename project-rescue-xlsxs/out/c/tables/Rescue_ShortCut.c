...
#include <string.h>
static bool Rescue_ShortCutParse(Rescue_ShortCutTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_ShortCutRecord_t*)sm_arena_alloc(
