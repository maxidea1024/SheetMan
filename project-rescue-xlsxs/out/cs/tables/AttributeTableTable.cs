...
{
    [System.Serializable]
    public partial class AttributeTableTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            /// 타겟 속성 타입
            /// </summary>
            public global::Rescue.Tables.AttributeType TargetAttributeType => _targetAttributeType;

            /// <summary>
            /// 증가되는 값(%)
            /// </summary>
            public float DamageValueRate => _damageValueRate;
            ...
            internal global::Rescue.Tables.AttributeType _targetAttributeType;
            internal float _damageValueRate;
            ...
            public override string ToString()
            {
                ...
                sb.Append(",\"AttributeName\":"); ToStringHelper.ToString(AttributeName, sb);
                sb.Append(",\"AttributeType\":"); ToStringHelper.ToString(AttributeType, sb);
                sb.Append(",\"TargetAttributeType\":"); ToStringHelper.ToString(TargetAttributeType, sb);
                sb.Append(",\"DamageValueRate\":"); ToStringHelper.ToString(DamageValueRate, sb);
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Name", "AttributeName", "AttributeType", "TargetAttributeType", "DamageValueRate", "IsVisible", "IconPath" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Name, r.AttributeName, r.AttributeType, r.TargetAttributeType, r.DamageValueRate, r.IsVisible, r.IconPath });
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `AttributeTable` that corresponds to field `Id` value {key}");
        ...
        public Task ReadAsync(LiteBinaryReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.Id", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.Name", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.AttributeName", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.Read(out record._attributeName);
                        }
                        break;

                    case 4:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.AttributeType", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.TargetAttributeType", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.ReadOptimalInt32(out tempEnumInt);
                            record._targetAttributeType = (global::Rescue.Tables.AttributeType)tempEnumInt;
                        }
                        break;

                    case 6:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.DamageValueRate", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementF32);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 7:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.IsVisible", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementBool);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 8:
                        LiteBinaryTable.CheckColumn(column, "AttributeTable.IconPath", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
