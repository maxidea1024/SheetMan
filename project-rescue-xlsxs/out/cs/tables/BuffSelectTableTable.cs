...
{
    [System.Serializable]
    public partial class BuffSelectTableTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            /// 확률
            /// </summary>
            public float BuffRate => _buffRate;

            /// <summary>
            /// 버프 튤팁
            /// </summary>
            public string BuffTooltip => _buffTooltip;
            ...
            internal int _buffID;
            internal global::Rescue.Tables.GradeType _grade;
            internal float _buffRate;
            internal string _buffTooltip = "";
            ...
            public override string ToString()
            {
                ...
                sb.Append(",\"BuffRate\":"); ToStringHelper.ToString(BuffRate, sb);
                sb.Append(",\"BuffTooltip\":"); ToStringHelper.ToString(BuffTooltip, sb);
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "BuffName", "BuffID", "Grade", "BuffRate", "BuffTooltip", "IconPath" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.BuffName, r.BuffID, r.Grade, r.BuffRate, r.BuffTooltip, r.IconPath });
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `BuffSelectTable` that corresponds to field `Id` value {key}");
        ...
        public Task ReadAsync(LiteBinaryReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        LiteBinaryTable.CheckColumn(column, "BuffSelectTable.Id", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        LiteBinaryTable.CheckColumn(column, "BuffSelectTable.BuffName", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        LiteBinaryTable.CheckColumn(column, "BuffSelectTable.BuffID", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 4:
                        LiteBinaryTable.CheckColumn(column, "BuffSelectTable.Grade", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        LiteBinaryTable.CheckColumn(column, "BuffSelectTable.BuffRate", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementF32);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.Read(out record._buffRate);
                        }
                        break;

                    case 6:
                        LiteBinaryTable.CheckColumn(column, "BuffSelectTable.BuffTooltip", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.Read(out record._buffTooltip);
                        }
                        break;

                    case 7:
                        LiteBinaryTable.CheckColumn(column, "BuffSelectTable.IconPath", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
