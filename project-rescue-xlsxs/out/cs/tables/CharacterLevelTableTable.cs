...
{
    [System.Serializable]
    public partial class CharacterLevelTableTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            /// 필요 경험치
            /// </summary>
            public long CharacterEXP => _characterEXP;

            /// <summary>
            /// 누적 경험치
            /// </summary>
            public long AccumulatedEXP => _accumulatedEXP;

            /// <summary>
            /// 공격력 고정 비율
            /// </summary>
            public float ATKGrowth => _aTKGrowth;
            ...
            internal int _level;
            internal long _characterEXP;
            internal long _accumulatedEXP;
            internal float _aTKGrowth;
            internal float _dEFGrowth;
            internal float _hPGrowth;
            #endregion
            ...
            public override string ToString()
            {
                ...
                sb.Append(",\"CharacterEXP\":"); ToStringHelper.ToString(CharacterEXP, sb);
                sb.Append(",\"AccumulatedEXP\":"); ToStringHelper.ToString(AccumulatedEXP, sb);
                sb.Append(",\"ATKGrowth\":"); ToStringHelper.ToString(ATKGrowth, sb);
                sb.Append(",\"DEFGrowth\":"); ToStringHelper.ToString(DEFGrowth, sb);
                sb.Append(",\"HPGrowth\":"); ToStringHelper.ToString(HPGrowth, sb);
                sb.Append("}");
                return sb.ToString();
            }
            #endregion
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Name", "NameKR", "Level", "CharacterEXP", "AccumulatedEXP", "ATKGrowth", "DEFGrowth", "HPGrowth" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Name, r.NameKR, r.Level, r.CharacterEXP, r.AccumulatedEXP, r.ATKGrowth, r.DEFGrowth, r.HPGrowth });
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `CharacterLevelTable` that corresponds to field `Id` value {key}");
        ...
        public Task ReadAsync(LiteBinaryReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.Id", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.Name", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.NameKR", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 4:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.Level", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.CharacterEXP", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI64, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 6:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.AccumulatedEXP", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI64, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 7:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.ATKGrowth", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementF32);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 8:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.DEFGrowth", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementF32);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 9:
                        LiteBinaryTable.CheckColumn(column, "CharacterLevelTable.HPGrowth", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementF32);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
