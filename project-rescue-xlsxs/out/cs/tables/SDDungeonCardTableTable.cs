...
{
    [System.Serializable]
    public partial class SDDungeonCardTableTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            /// 한글명
            /// </summary>
            public string SDDunName => _sDDunName;

            /// <summary>
            /// 카드 타입
            /// </summary>
            public global::Rescue.Tables.SDCardType SDCardType => _sDCardType;
            ...
            /// 스탯 아이콘 경로
            /// </summary>
            public string StatIconPath => _statIconPath;
            ...
            internal string _sDDunName = "";
            internal global::Rescue.Tables.SDCardType _sDCardType;
            internal int _cardCount;
            internal string _statIconPath = "";
            ...
            public override string ToString()
            {
                ...
                sb.Append(",\"SDDunName\":"); ToStringHelper.ToString(SDDunName, sb);
                sb.Append(",\"SDCardType\":"); ToStringHelper.ToString(SDCardType, sb);
                sb.Append(",\"CardCount\":"); ToStringHelper.ToString(CardCount, sb);
                sb.Append(",\"StatIconPath\":"); ToStringHelper.ToString(StatIconPath, sb);
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Name", "SDDunName", "SDCardType", "CardCount", "StatIconPath", "IconPath" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Name, r.SDDunName, r.SDCardType, r.CardCount, r.StatIconPath, r.IconPath });
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `SDDungeonCardTable` that corresponds to field `Id` value {key}");
        ...
        public Task ReadAsync(LiteBinaryReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        LiteBinaryTable.CheckColumn(column, "SDDungeonCardTable.Id", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        LiteBinaryTable.CheckColumn(column, "SDDungeonCardTable.Name", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        LiteBinaryTable.CheckColumn(column, "SDDungeonCardTable.SDDunName", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.Read(out record._sDDunName);
                        }
                        break;

                    case 4:
                        LiteBinaryTable.CheckColumn(column, "SDDungeonCardTable.SDCardType", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.ReadOptimalInt32(out tempEnumInt);
                            record._sDCardType = (global::Rescue.Tables.SDCardType)tempEnumInt;
                        }
                        break;

                    case 5:
                        LiteBinaryTable.CheckColumn(column, "SDDungeonCardTable.CardCount", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 6:
                        LiteBinaryTable.CheckColumn(column, "SDDungeonCardTable.StatIconPath", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.Read(out record._statIconPath);
                        }
                        break;

                    case 7:
                        LiteBinaryTable.CheckColumn(column, "SDDungeonCardTable.IconPath", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
