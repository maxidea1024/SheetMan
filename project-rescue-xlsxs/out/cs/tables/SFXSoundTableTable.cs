...
{
    [System.Serializable]
    public partial class SFXSoundTableTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            /// 카테고리
            /// </summary>
            public global::Rescue.Tables.SFXCategoryType Category => _category;
            ...
            /// 프리로드
            /// </summary>
            public string PreloadGroup => _preloadGroup;
            ...
            internal global::Rescue.Tables.SFXCategoryType _category;
            internal string _path = "";
            internal string _preloadGroup = "";
            ...
            public override string ToString()
            {
                ...
                sb.Append(",\"PreloadGroup\":"); ToStringHelper.ToString(PreloadGroup, sb);
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Name", "Category", "Path", "PreloadGroup", "Description" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Name, r.Category, r.Path, r.PreloadGroup, r.Description });
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `SFXSoundTable` that corresponds to field `Id` value {key}");
        ...
        public Task ReadAsync(LiteBinaryReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        LiteBinaryTable.CheckColumn(column, "SFXSoundTable.Id", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        LiteBinaryTable.CheckColumn(column, "SFXSoundTable.Name", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        LiteBinaryTable.CheckColumn(column, "SFXSoundTable.Category", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.ReadOptimalInt32(out tempEnumInt);
                            record._category = (global::Rescue.Tables.SFXCategoryType)tempEnumInt;
                        }
                        break;

                    case 4:
                        LiteBinaryTable.CheckColumn(column, "SFXSoundTable.Path", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.Read(out record._path);
                        }
                        break;

                    case 5:
                        LiteBinaryTable.CheckColumn(column, "SFXSoundTable.PreloadGroup", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.Read(out record._preloadGroup);
                        }
                        break;

                    case 6:
                        LiteBinaryTable.CheckColumn(column, "SFXSoundTable.Description", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
