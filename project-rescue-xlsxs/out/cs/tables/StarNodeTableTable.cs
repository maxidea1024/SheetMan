...
{
    [System.Serializable]
    public partial class StarNodeTableTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            /// 한글
            /// </summary>
            public string StarNodeName => _starNodeName;
            ...
            /// 증가 Value
            /// </summary>
            public int StarNodeValue => _starNodeValue;

            /// <summary>
            /// 증가 Rate
            /// </summary>
            public float StarNodeRate => _starNodeRate;
            ...
            internal string _starNodeName = "";
            internal global::Rescue.Tables.StatType _statType;
            internal int _starNodeValue;
            internal float _starNodeRate;
            internal int[] _unlockCondition = System.Array.Empty<int>();
            ...
            public override string ToString()
            {
                ...
                sb.Append(",\"StarNodeName\":"); ToStringHelper.ToString(StarNodeName, sb);
                sb.Append(",\"StatType\":"); ToStringHelper.ToString(StatType, sb);
                sb.Append(",\"StarNodeValue\":"); ToStringHelper.ToString(StarNodeValue, sb);
                sb.Append(",\"StarNodeRate\":"); ToStringHelper.ToString(StarNodeRate, sb);
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Name", "InfuluenceStep", "StarNodeName", "StatType", "StarNodeValue", "StarNodeRate", "UnlockCondition", "Description", "IconPath" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Name, r.InfuluenceStep, r.StarNodeName, r.StatType, r.StarNodeValue, r.StarNodeRate, r.UnlockCondition, r.Description, r.IconPath });
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `StarNodeTable` that corresponds to field `Id` value {key}");
        ...
        public Task ReadAsync(LiteBinaryReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.Id", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.Name", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.InfuluenceStep", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 4:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.StarNodeName", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.StatType", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 6:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.StarNodeValue", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 7:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.StarNodeRate", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementF32);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 8:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.UnlockCondition", LiteBinaryTable.KindVarArray, 0, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.TryReadCounter32(out int elementCount);
                            record._unlockCondition = new int[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._unlockCondition[j] = reader.ReadI32As(column.Element);
                            }
                        }
                        break;

                    case 9:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.Description", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 10:
                        LiteBinaryTable.CheckColumn(column, "StarNodeTable.IconPath", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
