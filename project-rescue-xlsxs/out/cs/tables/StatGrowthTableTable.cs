...
{
    [System.Serializable]
    public partial class StatGrowthTableTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            /// 스탯 누적 값(신규 추가)
            /// </summary>
            public int GrowthReselt => _growthReselt;
            ...
            internal int _growth;
            internal int _growthValue;
            internal int _growthReselt;
            ...
            public override string ToString()
            {
                ...
                sb.Append(",\"Growth\":"); ToStringHelper.ToString(Growth, sb);
                sb.Append(",\"GrowthValue\":"); ToStringHelper.ToString(GrowthValue, sb);
                sb.Append(",\"GrowthReselt\":"); ToStringHelper.ToString(GrowthReselt, sb);
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Name", "StageName", "StatType", "InfuluenceStep", "Growth", "GrowthValue", "GrowthReselt", "IconPath" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Name, r.StageName, r.StatType, r.InfuluenceStep, r.Growth, r.GrowthValue, r.GrowthReselt, r.IconPath });
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `StatGrowthTable` that corresponds to field `Id` value {key}");
        ...
        public Task ReadAsync(LiteBinaryReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.Id", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.Name", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.StageName", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 4:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.StatType", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.InfuluenceStep", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 6:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.Growth", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 7:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.GrowthValue", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 8:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.GrowthReselt", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementI32, LiteBinaryTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 9:
                        LiteBinaryTable.CheckColumn(column, "StatGrowthTable.IconPath", LiteBinaryTable.KindScalar, 1, LiteBinaryTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
