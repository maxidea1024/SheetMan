...
class ConfigTableTable {
  ...
  List<ConfigTableRecord> get records => _records;
  List<ConfigTableRecord> _records = [];

  Map<int, ConfigTableRecord> _byIndex = {};
  Map<String, ConfigTableRecord> _byId = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ConfigTableRecord? findByIndex(int key) => _byIndex[key];
  ...
  ConfigTableRecord getByIndexOrThrow(int key) {
  ...
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ConfigTableRecord? findById(String key) => _byId[key];
  ...
  /// cannot otherwise tell whether the next line is a null check or a catch.
  ConfigTableRecord getByIdOrThrow(String key) {
  ...
  void read(String filename) {
    ...
    final loaded = <ConfigTableRecord>[];
    final loadedByIndex = <int, ConfigTableRecord>{};
    final loadedById = <String, ConfigTableRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ConfigTableRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'ConfigTable.Index', kindScalar, 1, [elementI32, elementVarint]);
          for (final record in loaded) {
            record.index = reader.readI32As(column.element);
          }
          break;
        case 2:
          checkColumn(column, 'ConfigTable.Id', kindScalar, 1, [elementString]);
          for (final record in loaded) {
            record.id = reader.readString();
          }
          break;
        case 3:
          checkColumn(column, 'ConfigTable.Category', kindScalar, 1, [elementString]);
          for (final record in loaded) {
            record.category = reader.readString();
          }
          break;
        case 4:
          checkColumn(column, 'ConfigTable.DataType', kindScalar, 1, [elementString]);
          for (final record in loaded) {
            record.dataType = reader.readString();
          }
          break;
        case 5:
          checkColumn(column, 'ConfigTable.DefaultValue', kindScalar, 1, [elementString]);
          for (final record in loaded) {
            record.defaultValue = reader.readString();
          }
          break;
        case 6:
          checkColumn(column, 'ConfigTable.Description', kindScalar, 1, [elementString]);
          for (final record in loaded) {
