...
public final class AttributeTable {
    private List<AttributeRecord> records = new ArrayList<>();
    private Map<Integer, AttributeRecord> byId = new HashMap<>();
     ...
     */
    public AttributeRecord findById(int key) {
        return byId.get(key);
    }
     ...
     */
    public AttributeRecord getByIdOrThrow(int key) {
    ...
    public void read(Path filename) {
        ...
        Map<Integer, AttributeRecord> loadedById = new HashMap<>(count * 2);
