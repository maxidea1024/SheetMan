...
public final class CostCurveRangeTable {
    private List<CostCurveRangeRecord> records = new ArrayList<>();
    private Map<Integer, CostCurveRangeRecord> byId = new HashMap<>();
     ...
     */
    public List<CostCurveRangeRecord> records() {
        return records;
    }
     ...
     */
    public CostCurveRangeRecord findById(int key) {
        return byId.get(key);
    }
     ...
     */
    public CostCurveRangeRecord getByIdOrThrow(int key) {
    ...
    public void read(Path filename) {
        ...
        Map<Integer, CostCurveRangeRecord> loadedById = new HashMap<>(count * 2);
