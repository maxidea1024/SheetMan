...
public final class GachaRateTable {
    private List<GachaRateRecord> records = new ArrayList<>();
    private Map<Integer, GachaRateRecord> byId = new HashMap<>();
     ...
     */
    public List<GachaRateRecord> records() {
        return records;
    }
     ...
     */
    public GachaRateRecord findById(int key) {
        return byId.get(key);
    }
     ...
     */
    public GachaRateRecord getByIdOrThrow(int key) {
    ...
    public void read(Path filename) {
        ...
        Map<Integer, GachaRateRecord> loadedById = new HashMap<>(count * 2);
