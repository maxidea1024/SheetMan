        ...
        for (ScbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                case 1: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.Id");
                ...
                case 2: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.Name");
                    for (OopartsDungeonRewardRecord record : loaded) {
                ...
                case 3: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardName");
                    for (OopartsDungeonRewardRecord record : loaded) {
                ...
                case 4: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardType1");
                    for (OopartsDungeonRewardRecord record : loaded) {
                ...
                case 5: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardValue1");
                    for (OopartsDungeonRewardRecord record : loaded) {
                ...
                case 6: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardType2");
                    for (OopartsDungeonRewardRecord record : loaded) {
                ...
                case 7: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardValue2");
                    for (OopartsDungeonRewardRecord record : loaded) {
                ...
                case 9: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.FirstClearRewardType");
                    for (OopartsDungeonRewardRecord record : loaded) {
                ...
                case 10: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "OopartsDungeonReward.FirstClearRewardValue");
                    for (OopartsDungeonRewardRecord record : loaded) {
