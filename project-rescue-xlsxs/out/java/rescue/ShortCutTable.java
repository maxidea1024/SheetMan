...
public final class ShortCutTable {
    private List<ShortCutRecord> records = new ArrayList<>();
    private Map<Integer, ShortCutRecord> byID = new HashMap<>();
     ...
     */
    public List<ShortCutRecord> records() {
        return records;
    }
     ...
     */
    public ShortCutRecord findByID(int key) {
        return byID.get(key);
    }
     ...
     */
    public ShortCutRecord getByIDOrThrow(int key) {
    ...
    public void read(Path filename) {
        ...
        List<ShortCutRecord> loaded = new ArrayList<>(count);
        Map<Integer, ShortCutRecord> loadedByID = new HashMap<>(count * 2);
        ...
        for (ScbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                case 1: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ShortCut.ID");
                ...
                case 2: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ShortCut.Name");
                    for (ShortCutRecord record : loaded) {
                ...
                case 3: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ShortCut.Type");
                    for (ShortCutRecord record : loaded) {
                ...
                case 4: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ShortCut.SubIndex");
                    for (ShortCutRecord record : loaded) {
                ...
                case 5: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ShortCut.Description");
                    for (ShortCutRecord record : loaded) {
