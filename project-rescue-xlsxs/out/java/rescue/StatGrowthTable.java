        ...
        for (ScbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                case 1: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.Id");
                ...
                case 2: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.Name");
                    for (StatGrowthRecord record : loaded) {
                ...
                case 3: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.StageName");
                    for (StatGrowthRecord record : loaded) {
                ...
                case 4: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.StatType");
                    for (StatGrowthRecord record : loaded) {
                ...
                case 5: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.InfuluenceStep");
                    for (StatGrowthRecord record : loaded) {
                ...
                case 6: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.Growth");
                    for (StatGrowthRecord record : loaded) {
                ...
                case 7: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.GrowthValue");
                    for (StatGrowthRecord record : loaded) {
                ...
                case 8: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.GrowthReselt");
                    for (StatGrowthRecord record : loaded) {
                ...
                case 9: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "StatGrowth.IconPath");
                    for (StatGrowthRecord record : loaded) {
