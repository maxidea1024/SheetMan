...
class CharacterLevelTableTable {
     ...
     */
    var records: MutableList<CharacterLevelTableRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, CharacterLevelTableRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CharacterLevelTableRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CharacterLevelTableRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CharacterLevelTableRecord>(count)
        val loadedById = HashMap<Int, CharacterLevelTableRecord>(count * 2)

        repeat(count) { loaded.add(CharacterLevelTableRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "CharacterLevelTable.Id", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.id = reader.readI32As(column.element)
                    }
                }
                2 -> {
                    checkColumn(column, "CharacterLevelTable.Name", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.name = reader.readString()
                    }
                }
                3 -> {
                    checkColumn(column, "CharacterLevelTable.NameKR", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.nameKR = reader.readString()
                    }
                }
                4 -> {
                    checkColumn(column, "CharacterLevelTable.Level", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.level = reader.readI32As(column.element)
                    }
                }
                5 -> {
                    checkColumn(column, "CharacterLevelTable.CharacterEXP", KIND_SCALAR, 1, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.characterEXP = reader.readI64As(column.element)
                    }
                }
                6 -> {
                    checkColumn(column, "CharacterLevelTable.AccumulatedEXP", KIND_SCALAR, 1, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.accumulatedEXP = reader.readI64As(column.element)
                    }
                }
                7 -> {
                    checkColumn(column, "CharacterLevelTable.ATKGrowth", KIND_SCALAR, 1, ELEMENT_F32)
                    for (record in loaded) {
                        record.aTKGrowth = reader.readFloat()
                    }
                }
                8 -> {
                    checkColumn(column, "CharacterLevelTable.DEFGrowth", KIND_SCALAR, 1, ELEMENT_F32)
                    for (record in loaded) {
                        record.dEFGrowth = reader.readFloat()
                    }
                }
                9 -> {
                    checkColumn(column, "CharacterLevelTable.HPGrowth", KIND_SCALAR, 1, ELEMENT_F32)
                    for (record in loaded) {
