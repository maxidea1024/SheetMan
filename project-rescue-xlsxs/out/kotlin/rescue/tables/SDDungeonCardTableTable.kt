...
class SDDungeonCardTableTable {
     ...
     */
    var records: MutableList<SDDungeonCardTableRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, SDDungeonCardTableRecord> = HashMap()
     ...
     */
    fun findById(key: Int): SDDungeonCardTableRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): SDDungeonCardTableRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<SDDungeonCardTableRecord>(count)
        val loadedById = HashMap<Int, SDDungeonCardTableRecord>(count * 2)

        repeat(count) { loaded.add(SDDungeonCardTableRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "SDDungeonCardTable.Id", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.id = reader.readI32As(column.element)
                    }
                }
                2 -> {
                    checkColumn(column, "SDDungeonCardTable.Name", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.name = reader.readString()
                    }
                }
                3 -> {
                    checkColumn(column, "SDDungeonCardTable.SDDunName", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.sDDunName = reader.readString()
                    }
                }
                4 -> {
                    checkColumn(column, "SDDungeonCardTable.SDCardType", KIND_SCALAR, 1, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.sDCardType = SDCardType.of(reader.readEnum())
                    }
                }
                5 -> {
                    checkColumn(column, "SDDungeonCardTable.CardCount", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.cardCount = reader.readI32As(column.element)
                    }
                }
                6 -> {
                    checkColumn(column, "SDDungeonCardTable.StatIconPath", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.statIconPath = reader.readString()
                    }
                }
                7 -> {
                    checkColumn(column, "SDDungeonCardTable.IconPath", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
