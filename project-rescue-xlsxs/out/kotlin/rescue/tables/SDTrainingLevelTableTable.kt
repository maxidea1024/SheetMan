...
class SDTrainingLevelTableTable {
     ...
     */
    var records: MutableList<SDTrainingLevelTableRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, SDTrainingLevelTableRecord> = HashMap()
     ...
     */
    fun findById(key: Int): SDTrainingLevelTableRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): SDTrainingLevelTableRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<SDTrainingLevelTableRecord>(count)
        val loadedById = HashMap<Int, SDTrainingLevelTableRecord>(count * 2)

        repeat(count) { loaded.add(SDTrainingLevelTableRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "SDTrainingLevelTable.Id", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.id = reader.readI32As(column.element)
                    }
                }
                2 -> {
                    checkColumn(column, "SDTrainingLevelTable.Name", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.name = reader.readString()
                    }
                }
                3 -> {
                    checkColumn(column, "SDTrainingLevelTable.LevelName", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.levelName = reader.readString()
                    }
                }
                4 -> {
                    checkColumn(column, "SDTrainingLevelTable.CurrencyValue", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.currencyValue = reader.readI32As(column.element)
                    }
                }
                5 -> {
                    checkColumn(column, "SDTrainingLevelTable.CurrencyResult", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.currencyResult = reader.readI32As(column.element)
                    }
                }
                6 -> {
                    checkColumn(column, "SDTrainingLevelTable.MHPGrowth", KIND_SCALAR, 1, ELEMENT_F32)
                    for (record in loaded) {
                        record.mHPGrowth = reader.readFloat()
                    }
                }
                7 -> {
                    checkColumn(column, "SDTrainingLevelTable.MHPTotal", KIND_SCALAR, 1, ELEMENT_F32)
                    for (record in loaded) {
                        record.mHPTotal = reader.readFloat()
                    }
                }
                8 -> {
                    checkColumn(column, "SDTrainingLevelTable.DEFGrowth", KIND_SCALAR, 1, ELEMENT_F32)
                    for (record in loaded) {
                        record.dEFGrowth = reader.readFloat()
                    }
                }
                9 -> {
                    checkColumn(column, "SDTrainingLevelTable.DEFTotal", KIND_SCALAR, 1, ELEMENT_F32)
                    for (record in loaded) {
                        record.dEFTotal = reader.readFloat()
                    }
                }
                10 -> {
                    checkColumn(column, "SDTrainingLevelTable.CommonUnlockStageID", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
