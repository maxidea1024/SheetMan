...
class StatGrowthTableTable {
     ...
     */
    var records: MutableList<StatGrowthTableRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, StatGrowthTableRecord> = HashMap()
     ...
     */
    fun findById(key: Int): StatGrowthTableRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): StatGrowthTableRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<StatGrowthTableRecord>(count)
        val loadedById = HashMap<Int, StatGrowthTableRecord>(count * 2)

        repeat(count) { loaded.add(StatGrowthTableRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "StatGrowthTable.Id", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.id = reader.readI32As(column.element)
                    }
                }
                2 -> {
                    checkColumn(column, "StatGrowthTable.Name", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.name = reader.readString()
                    }
                }
                3 -> {
                    checkColumn(column, "StatGrowthTable.StageName", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
                        record.stageName = reader.readString()
                    }
                }
                4 -> {
                    checkColumn(column, "StatGrowthTable.StatType", KIND_SCALAR, 1, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.statType = StatType.of(reader.readEnum())
                    }
                }
                5 -> {
                    checkColumn(column, "StatGrowthTable.InfuluenceStep", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.infuluenceStep = reader.readI32As(column.element)
                    }
                }
                6 -> {
                    checkColumn(column, "StatGrowthTable.Growth", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.growth = reader.readI32As(column.element)
                    }
                }
                7 -> {
                    checkColumn(column, "StatGrowthTable.GrowthValue", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.growthValue = reader.readI32As(column.element)
                    }
                }
                8 -> {
                    checkColumn(column, "StatGrowthTable.GrowthReselt", KIND_SCALAR, 1, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
                        record.growthReselt = reader.readI32As(column.element)
                    }
                }
                9 -> {
                    checkColumn(column, "StatGrowthTable.IconPath", KIND_SCALAR, 1, ELEMENT_STRING)
                    for (record in loaded) {
