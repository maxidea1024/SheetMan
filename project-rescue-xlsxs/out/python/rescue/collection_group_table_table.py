...
class CollectionGroupTableRecord:
    ...
    def __repr__(self):
        return "CollectionGroupTableRecord(id=%r, name=%r, index=%r, character_list=%r, prefab_path=%r)" % (self.id, self.name, self.index, self.character_list, self.prefab_path)
...
class CollectionGroupTableTable:
    ...
    def read(self, filename):
        ...
        records = [CollectionGroupTableRecord() for _ in range(count)]
