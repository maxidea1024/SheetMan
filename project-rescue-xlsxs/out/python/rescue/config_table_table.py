...
class ConfigTableRecord:
    ...
    def __repr__(self):
        return "ConfigTableRecord(index=%r, id=%r, category=%r, data_type=%r, default_value=%r, description=%r)" % (self.index, self.id, self.category, self.data_type, self.default_value, self.description)
...
class ConfigTableTable:
    ...
    def read(self, filename):
        ...
        records = [ConfigTableRecord() for _ in range(count)]
