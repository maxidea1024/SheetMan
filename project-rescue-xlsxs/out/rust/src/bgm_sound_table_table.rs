...
pub struct BGMSoundTableRecord {
    /// BGMSound_Table
    pub id: i32,
    /// 영문
    pub name: String,
...
impl BGMSoundTableRecord {
}

/// Every row of BGMSoundTable.
#[derive(Clone, Debug, Default)]
pub struct BGMSoundTableTable {
    records: Vec<BGMSoundTableRecord>,
    by_id: HashMap<i32, usize>,
}

impl BGMSoundTableTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[BGMSoundTableRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&BGMSoundTableRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&BGMSoundTableRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![BGMSoundTableRecord::default(); count];
