...
pub struct CharacterLevelTableRecord {
    /// Index
    pub id: i32,
    /// 영문
    pub name: String,
...
impl CharacterLevelTableRecord {
}

/// Every row of CharacterLevelTable.
#[derive(Clone, Debug, Default)]
pub struct CharacterLevelTableTable {
    records: Vec<CharacterLevelTableRecord>,
    by_id: HashMap<i32, usize>,
}

impl CharacterLevelTableTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[CharacterLevelTableRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&CharacterLevelTableRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&CharacterLevelTableRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![CharacterLevelTableRecord::default(); count];
