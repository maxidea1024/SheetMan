...
impl CostCurveRangeTableRecord {
}

/// Every row of CostCurveRangeTable.
#[derive(Clone, Debug, Default)]
pub struct CostCurveRangeTableTable {
    records: Vec<CostCurveRangeTableRecord>,
    by_id: HashMap<i32, usize>,
}

impl CostCurveRangeTableTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[CostCurveRangeTableRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&CostCurveRangeTableRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&CostCurveRangeTableRecord> {
        self.by_id
            .get(&key)
            .map(|position| &self.records[*position])
            .ok_or_else(|| sheetman::Error::RecordNotFound {
                table: "CostCurveRangeTable",
                field: "Id",
                key: format!("{:?}", key),
            })
    }
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![CostCurveRangeTableRecord::default(); count];
