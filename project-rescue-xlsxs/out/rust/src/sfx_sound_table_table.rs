...
impl SFXSoundTableRecord {
}

/// Every row of SFXSoundTable.
#[derive(Clone, Debug, Default)]
pub struct SFXSoundTableTable {
    records: Vec<SFXSoundTableRecord>,
    by_id: HashMap<i32, usize>,
}

impl SFXSoundTableTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[SFXSoundTableRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&SFXSoundTableRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&SFXSoundTableRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![SFXSoundTableRecord::default(); count];
