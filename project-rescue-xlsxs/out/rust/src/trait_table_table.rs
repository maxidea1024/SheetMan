...
impl TraitTableRecord {
}

/// Every row of TraitTable.
#[derive(Clone, Debug, Default)]
pub struct TraitTableTable {
    records: Vec<TraitTableRecord>,
    by_id: HashMap<i32, usize>,
}

impl TraitTableTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[TraitTableRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&TraitTableRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&TraitTableRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![TraitTableRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                1 => {
                    sheetman::check_column(column, "TraitTable.Id", sheetman::KIND_SCALAR, 1, &[sheetman::ELEMENT_I32, sheetman::ELEMENT_VARINT])?;
                    for record in records.iter_mut() {
                        record.id = reader.read_i32_as(column.element)?;
                    }
                }
                2 => {
                    sheetman::check_column(column, "TraitTable.Name", sheetman::KIND_SCALAR, 1, &[sheetman::ELEMENT_STRING])?;
                    for record in records.iter_mut() {
                        record.name = reader.read_string()?;
                    }
                }
                3 => {
                    sheetman::check_column(column, "TraitTable.TraitName", sheetman::KIND_SCALAR, 1, &[sheetman::ELEMENT_STRING])?;
                    for record in records.iter_mut() {
                        record.trait_name = reader.read_string()?;
                    }
                }
                4 => {
                    sheetman::check_column(column, "TraitTable.StatType", sheetman::KIND_SCALAR, 1, &[sheetman::ELEMENT_VARINT])?;
                    for record in records.iter_mut() {
                        record.stat_type = StatType::from_value(reader.read_enum()?).unwrap_or_default();
                    }
                }
                5 => {
                    sheetman::check_column(column, "TraitTable.StatRate", sheetman::KIND_SCALAR, 1, &[sheetman::ELEMENT_F32])?;
                    for record in records.iter_mut() {
                        record.stat_rate = reader.read_f32()?;
                    }
                }
                6 => {
                    sheetman::check_column(column, "TraitTable.UnlockCondition", sheetman::KIND_VAR_ARRAY, 0, &[sheetman::ELEMENT_I32, sheetman::ELEMENT_VARINT])?;
                    for record in records.iter_mut() {
                ...
                7 => {
                    sheetman::check_column(column, "TraitTable.IconPath", sheetman::KIND_SCALAR, 1, &[sheetman::ELEMENT_STRING])?;
                    for record in records.iter_mut() {
