...
#include <string.h>
static bool Rescue_PackageParse(Rescue_PackageTable_t* table, sm_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (Rescue_PackageRecord_t*)sm_arena_alloc(
  ...
  for (at = 0; at < column_count && !sm_failed(reader); ++at) {
    ...
    case 6:
      (void)sm_check_column(reader, column, "Package.Stackable", SM_KIND_SCALAR, 1, SM_ELEMENT_MASK(SM_ELEMENT_BOOL));

      (void)sm_cursor_init(&cursor, reader, column, table->count, "Package.Stackable");
    ...
    case 11:
      (void)sm_check_column(reader, column, "Package.CurrencyID", SM_KIND_VAR_ARRAY, 0, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 12:
      (void)sm_check_column(reader, column, "Package.CurrencyItemMin", SM_KIND_VAR_ARRAY, 0, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 13:
      (void)sm_check_column(reader, column, "Package.CurrencyItemMax", SM_KIND_VAR_ARRAY, 0, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
    ...
    case 14:
      (void)sm_check_column(reader, column, "Package.CurrencyItemRate", SM_KIND_VAR_ARRAY, 0, SM_ELEMENT_MASK(SM_ELEMENT_I32) | SM_ELEMENT_MASK(SM_ELEMENT_VARINT));
