...
#ifndef SHEETMAN_GENERATED_TABLES_EXP_DUNGEON_STAGE_H
#define SHEETMAN_GENERATED_TABLES_EXP_DUNGEON_STAGE_H
...
class ExpDungeonStageTable {
 public:
  const std::vector<ExpDungeonStageRecord>& records() const { return records_; }

  /// The row with this Id, or nullptr when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  const ExpDungeonStageRecord* find_by_id(std::int32_t key) const {
  ...
  const ExpDungeonStageRecord& get_by_id_or_throw(std::int32_t key) const {
    const ExpDungeonStageRecord* found = find_by_id(key);

    if (found == nullptr) {
      throw sheetman::RecordNotFound(
        std::string("there is no record in table `ExpDungeonStage` that corresponds to "
  ...
  void read(const std::string& filename) {
    ...
    std::vector<ExpDungeonStageRecord> records;
    ...
    for (const sheetman::Column& column : header.columns) {
      ...
      switch (column.tag) {
        ...
        case 7: {
          sheetman::check_column(column, "ExpDungeonStage.SpawnIds", sheetman::kKindVarArray, 0, {sheetman::kElementI32, sheetman::kElementVarint});
          for (std::size_t i = 0; i < row_count; ++i) {
            auto& record = records[i];
        ...
        case 8: {
          sheetman::check_column(column, "ExpDungeonStage.BossID", sheetman::kKindVarArray, 0, {sheetman::kElementI32, sheetman::kElementVarint});
          for (std::size_t i = 0; i < row_count; ++i) {
            auto& record = records[i];
            const std::int32_t element_count = reader.read_counter32();
        ...
        case 11: {
          sheetman::check_column(column, "ExpDungeonStage.SpawnNextTime", sheetman::kKindScalar, 1, {sheetman::kElementF32});
          sheetman::ScbColumnCursor cursor(reader, column, header.row_count, "ExpDungeonStage.SpawnNextTime");
          for (std::size_t i = 0; i < row_count; ++i) {
            auto& record = records[i];
        ...
        case 15: {
          sheetman::check_column(column, "ExpDungeonStage.AtkUpPercent", sheetman::kKindScalar, 1, {sheetman::kElementF32});
          sheetman::ScbColumnCursor cursor(reader, column, header.row_count, "ExpDungeonStage.AtkUpPercent");
          for (std::size_t i = 0; i < row_count; ++i) {
            auto& record = records[i];
        ...
        case 16: {
          sheetman::check_column(column, "ExpDungeonStage.DefUpPercent", sheetman::kKindScalar, 1, {sheetman::kElementF32});
          sheetman::ScbColumnCursor cursor(reader, column, header.row_count, "ExpDungeonStage.DefUpPercent");
          for (std::size_t i = 0; i < row_count; ++i) {
            auto& record = records[i];
        ...
        case 17: {
          sheetman::check_column(column, "ExpDungeonStage.MHPUpPercent", sheetman::kKindScalar, 1, {sheetman::kElementF32});
          sheetman::ScbColumnCursor cursor(reader, column, header.row_count, "ExpDungeonStage.MHPUpPercent");
          for (std::size_t i = 0; i < row_count; ++i) {
            auto& record = records[i];
 ...
 private:
  ...
  void publish(std::vector<ExpDungeonStageRecord>&& records) {
  ...
  std::vector<ExpDungeonStageRecord> records_;
  std::unordered_map<std::int32_t, std::size_t> by_id_;
};

}  // namespace rescue

#endif  // SHEETMAN_GENERATED_TABLES_EXP_DUNGEON_STAGE_H
