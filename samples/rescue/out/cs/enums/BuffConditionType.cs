...
namespace Rescue.Tables
{
    ...
    /// </summary>
    public struct BuffConditionTypeComparer : IEqualityComparer<BuffConditionType>
    {
        public bool Equals(BuffConditionType x, BuffConditionType y)
        {
            return x == y;
        }

        public int GetHashCode(BuffConditionType obj)
        {
            return (int)obj;
        }
    }
