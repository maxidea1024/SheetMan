                ...
                switch (column.Tag)
                {
                    ...
                    case 3:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._artifactType = (global::Rescue.Tables.ArtifactJobType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 6:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._equipStatType = (global::Rescue.Tables.StatType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 8:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._collectionType = (global::Rescue.Tables.StatType)value;
                            } while (--n > 0);
                        }
                        break;
