                ...
                switch (column.Tag)
                {
                    ...
                    case 4:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._characterType = (global::Rescue.Tables.CharacterType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 6:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._attributeType = (global::Rescue.Tables.AttributeType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 7:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._jobType = (global::Rescue.Tables.JobType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 8:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._nation = (global::Rescue.Tables.NationType)value;
                            } while (--n > 0);
                        }
                        break;
