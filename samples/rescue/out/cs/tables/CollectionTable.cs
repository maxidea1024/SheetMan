                ...
                switch (column.Tag)
                {
                    ...
                    case 4:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._tabType = (global::Rescue.Tables.CollectionTabType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 8:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._rewardStatType1 = (global::Rescue.Tables.StatType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 10:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._rewardStatType2 = (global::Rescue.Tables.StatType)value;
                            } while (--n > 0);
                        }
                        break;
