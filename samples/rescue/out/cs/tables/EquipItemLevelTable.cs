...
{
    [System.Serializable]
    public partial class EquipItemLevelTable
    {
        #region Record
        [System.Serializable]
        ...
        public Record GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `EquipItemLevel` that corresponds to field `Id` value {key}");
