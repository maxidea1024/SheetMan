                ...
                switch (column.Tag)
                {
                    ...
                    case 5:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._growthType = (global::Rescue.Tables.GrowthType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 7:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._resetCostType = (global::Rescue.Tables.CurrencyType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 11:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._unlockConditionType = value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 12:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._unlockConditionValue = value;
                            } while (--n > 0);
                        }
                        break;
