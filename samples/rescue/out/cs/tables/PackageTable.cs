                ...
                switch (column.Tag)
                {
                    ...
                    case 5:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._packageType = (global::Rescue.Tables.ConsumablesType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 8:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._packageCondition = (global::Rescue.Tables.ConditionType)value;
                            } while (--n > 0);
                        }
                        break;
