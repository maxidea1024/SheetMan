                ...
                switch (column.Tag)
                {
                    ...
                    case 13:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._refreshCurrencyType = (global::Rescue.Tables.CurrencyType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 14:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._refreshCurrencyValue = value;
                            } while (--n > 0);
                        }
                        break;
