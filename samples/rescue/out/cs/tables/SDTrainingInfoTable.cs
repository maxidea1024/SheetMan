                ...
                switch (column.Tag)
                {
                    ...
                    case 7:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._levelUpCondition = value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 10:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._lvResetCurrencyType = (global::Rescue.Tables.CurrencyType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 11:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._lvResetCurrencyValue = value;
                            } while (--n > 0);
                        }
                        break;
