        ...
        public Task ReadAsync(ScbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 8:
                        ScbTable.CheckColumn(column, "StarNode.UnlockCondition", ScbTable.KindVarArray, 0, ScbTable.ElementI32, ScbTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
