...
class AttributeTable {
  ...
  List<AttributeRecord> get records => _records;
  List<AttributeRecord> _records = [];

  Map<int, AttributeRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  AttributeRecord? findById(int key) => _byId[key];
  ...
  AttributeRecord getByIdOrThrow(int key) {
  ...
  void read(String filename) {
    ...
    final loadedById = <int, AttributeRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(AttributeRecord());
    }
