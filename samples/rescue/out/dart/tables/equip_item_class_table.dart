...
class EquipItemClassTable {
  ...
  List<EquipItemClassRecord> get records => _records;
  List<EquipItemClassRecord> _records = [];

  Map<int, EquipItemClassRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  EquipItemClassRecord? findById(int key) => _byId[key];
  ...
  EquipItemClassRecord getByIdOrThrow(int key) {
  ...
  void read(String filename) {
    ...
    final loadedById = <int, EquipItemClassRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(EquipItemClassRecord());
    }
