        ...
        for (ScbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                case 1: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ClassUpCurrencyList.Id");
                ...
                case 2: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ClassUpCurrencyList.Name");
                    for (ClassUpCurrencyListRecord record : loaded) {
                ...
                case 3: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ClassUpCurrencyList.Type");
                    for (ClassUpCurrencyListRecord record : loaded) {
                ...
                case 4: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ClassUpCurrencyList.TargetId");
                    for (ClassUpCurrencyListRecord record : loaded) {
                ...
                case 5: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ClassUpCurrencyList.MaxCount");
                    for (ClassUpCurrencyListRecord record : loaded) {
                ...
                case 6: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ClassUpCurrencyList.MaxStack");
                    for (ClassUpCurrencyListRecord record : loaded) {
                ...
                case 7: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "ClassUpCurrencyList.IconPath");
                    for (ClassUpCurrencyListRecord record : loaded) {
