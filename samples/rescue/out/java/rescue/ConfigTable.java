        ...
        for (ScbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                case 1: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "Config.Index");
                ...
                case 2: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "Config.Id");
                    for (ConfigRecord record : loaded) {
                ...
                case 3: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "Config.Category");
                    for (ConfigRecord record : loaded) {
                ...
                case 4: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "Config.DataType");
                    for (ConfigRecord record : loaded) {
                ...
                case 5: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "Config.DefaultValue");
                    for (ConfigRecord record : loaded) {
                ...
                case 6: {
                    ...
                    cursor = new ScbReader.ColumnCursor(reader, column, count, "Config.Description");
                    for (ConfigRecord record : loaded) {
