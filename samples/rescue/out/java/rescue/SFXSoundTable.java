...
public final class SFXSoundTable {
    private List<SFXSoundRecord> records = new ArrayList<>();
    private Map<Integer, SFXSoundRecord> byId = new HashMap<>();
     ...
     */
    public List<SFXSoundRecord> records() {
        return records;
    }
     ...
     */
    public SFXSoundRecord findById(int key) {
        return byId.get(key);
    }
     ...
     */
    public SFXSoundRecord getByIdOrThrow(int key) {
    ...
    public void read(Path filename) {
        ...
        Map<Integer, SFXSoundRecord> loadedById = new HashMap<>(count * 2);
