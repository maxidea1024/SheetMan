...
class ArtifactLevelTable {
     ...
     */
    var records: MutableList<ArtifactLevelRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, ArtifactLevelRecord> = HashMap()
     ...
     */
    fun findById(key: Int): ArtifactLevelRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): ArtifactLevelRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<ArtifactLevelRecord>(count)
        val loadedById = HashMap<Int, ArtifactLevelRecord>(count * 2)

        repeat(count) { loaded.add(ArtifactLevelRecord()) }
