...
class CollectionGroupTable {
     ...
     */
    var records: MutableList<CollectionGroupRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, CollectionGroupRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CollectionGroupRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CollectionGroupRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CollectionGroupRecord>(count)
        val loadedById = HashMap<Int, CollectionGroupRecord>(count * 2)

        repeat(count) { loaded.add(CollectionGroupRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                ...
                4 -> {
                    checkColumn(column, "CollectionGroup.CharacterList", KIND_VAR_ARRAY, 0, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
