...
class CostCurveRangeTable {
     ...
     */
    var records: MutableList<CostCurveRangeRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, CostCurveRangeRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CostCurveRangeRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CostCurveRangeRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CostCurveRangeRecord>(count)
        val loadedById = HashMap<Int, CostCurveRangeRecord>(count * 2)

        repeat(count) { loaded.add(CostCurveRangeRecord()) }
