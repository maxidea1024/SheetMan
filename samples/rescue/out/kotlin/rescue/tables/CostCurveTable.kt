...
class CostCurveTable {
     ...
     */
    var records: MutableList<CostCurveRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, CostCurveRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CostCurveRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CostCurveRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CostCurveRecord>(count)
        val loadedById = HashMap<Int, CostCurveRecord>(count * 2)

        repeat(count) { loaded.add(CostCurveRecord()) }
