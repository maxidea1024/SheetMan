...
class InfoGrowthTable {
     ...
     */
    var records: MutableList<InfoGrowthRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, InfoGrowthRecord> = HashMap()
     ...
     */
    fun findById(key: Int): InfoGrowthRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): InfoGrowthRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<InfoGrowthRecord>(count)
        val loadedById = HashMap<Int, InfoGrowthRecord>(count * 2)

        repeat(count) { loaded.add(InfoGrowthRecord()) }
