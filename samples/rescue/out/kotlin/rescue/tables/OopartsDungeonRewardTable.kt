...
class OopartsDungeonRewardTable {
     ...
     */
    var records: MutableList<OopartsDungeonRewardRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, OopartsDungeonRewardRecord> = HashMap()
     ...
     */
    fun findById(key: Int): OopartsDungeonRewardRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): OopartsDungeonRewardRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<OopartsDungeonRewardRecord>(count)
        val loadedById = HashMap<Int, OopartsDungeonRewardRecord>(count * 2)

        repeat(count) { loaded.add(OopartsDungeonRewardRecord()) }
