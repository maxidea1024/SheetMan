...
class SDAlchemyStepTable {
     ...
     */
    var records: MutableList<SDAlchemyStepRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, SDAlchemyStepRecord> = HashMap()
     ...
     */
    fun findById(key: Int): SDAlchemyStepRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): SDAlchemyStepRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<SDAlchemyStepRecord>(count)
        val loadedById = HashMap<Int, SDAlchemyStepRecord>(count * 2)

        repeat(count) { loaded.add(SDAlchemyStepRecord()) }
