...
class SDPubInfoTable {
     ...
     */
    var records: MutableList<SDPubInfoRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, SDPubInfoRecord> = HashMap()
     ...
     */
    fun findById(key: Int): SDPubInfoRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): SDPubInfoRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<SDPubInfoRecord>(count)
        val loadedById = HashMap<Int, SDPubInfoRecord>(count * 2)

        repeat(count) { loaded.add(SDPubInfoRecord()) }
