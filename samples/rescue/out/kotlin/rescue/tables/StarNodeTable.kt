...
class StarNodeTable {
     ...
     */
    var records: MutableList<StarNodeRecord> = ArrayList()
        private set

    private var byId: HashMap<Int, StarNodeRecord> = HashMap()
     ...
     */
    fun findById(key: Int): StarNodeRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): StarNodeRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<StarNodeRecord>(count)
        val loadedById = HashMap<Int, StarNodeRecord>(count * 2)

        repeat(count) { loaded.add(StarNodeRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                ...
                8 -> {
                    checkColumn(column, "StarNode.UnlockCondition", KIND_VAR_ARRAY, 0, ELEMENT_I32, ELEMENT_VARINT)
                    for (record in loaded) {
