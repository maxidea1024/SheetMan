...
final class CashShopTable
{
    /** @var list<CashShopRecord> */
    public array $records = [];

    /** @var array<int, CashShopRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?CashShopRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): CashShopRecord
    {
