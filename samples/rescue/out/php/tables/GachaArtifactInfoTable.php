 ...
 */
final class GachaArtifactInfoRecord
{
...
final class GachaArtifactInfoTable
{
    /** @var list<GachaArtifactInfoRecord> */
    public array $records = [];

    /** @var array<int, GachaArtifactInfoRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?GachaArtifactInfoRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): GachaArtifactInfoRecord
    {
    ...
    public function read(string $filename): void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            $records[] = new GachaArtifactInfoRecord();
        }
