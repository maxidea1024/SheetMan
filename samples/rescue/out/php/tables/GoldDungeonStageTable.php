 ...
 */
final class GoldDungeonStageRecord
{
...
final class GoldDungeonStageTable
{
    /** @var list<GoldDungeonStageRecord> */
    public array $records = [];

    /** @var array<int, GoldDungeonStageRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?GoldDungeonStageRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): GoldDungeonStageRecord
    {
    ...
    public function read(string $filename): void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            $records[] = new GoldDungeonStageRecord();
        }
