...
final class InfoGrowthTable
{
    /** @var list<InfoGrowthRecord> */
    public array $records = [];

    /** @var array<int, InfoGrowthRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?InfoGrowthRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): InfoGrowthRecord
    {
