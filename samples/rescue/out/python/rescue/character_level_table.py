...
class CharacterLevelRecord:
    ...
    def __repr__(self):
        return "CharacterLevelRecord(id=%r, name=%r, name_kr=%r, level=%r, character_exp=%r, accumulated_exp=%r, atk_growth=%r, def_growth=%r, hp_growth=%r)" % (self.id, self.name, self.name_kr, self.level, self.character_exp, self.accumulated_exp, self.atk_growth, self.def_growth, self.hp_growth)
...
class CharacterLevelTable:
    ...
    def read(self, filename):
        ...
        records = [CharacterLevelRecord() for _ in range(count)]
