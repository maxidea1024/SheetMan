...
class ClassUpCurrencyListRecord:
    ...
    def __repr__(self):
        return "ClassUpCurrencyListRecord(id=%r, name=%r, type_=%r, target_id=%r, max_count=%r, max_stack=%r, icon_path=%r, short_cut_index=%r)" % (self.id, self.name, self.type_, self.target_id, self.max_count, self.max_stack, self.icon_path, self.short_cut_index)
...
class ClassUpCurrencyListTable:
    ...
    def read(self, filename):
        ...
        records = [ClassUpCurrencyListRecord() for _ in range(count)]
