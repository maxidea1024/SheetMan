...
class CollectionGroupRecord:
    ...
    def __repr__(self):
        return "CollectionGroupRecord(id=%r, name=%r, index=%r, character_list=%r, prefab_path=%r)" % (self.id, self.name, self.index, self.character_list, self.prefab_path)
...
class CollectionGroupTable:
    ...
    def read(self, filename):
        ...
        records = [CollectionGroupRecord() for _ in range(count)]
