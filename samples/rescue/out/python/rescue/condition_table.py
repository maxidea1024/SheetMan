...
class ConditionRecord:
    ...
    def __repr__(self):
        return "ConditionRecord(id=%r, name=%r, condition_target_type=%r, condition_target_value=%r, condition_type=%r, condition_value=%r)" % (self.id, self.name, self.condition_target_type, self.condition_target_value, self.condition_type, self.condition_value)
