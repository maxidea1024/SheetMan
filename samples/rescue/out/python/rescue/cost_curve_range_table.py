...
class CostCurveRangeRecord:
    ...
    def __repr__(self):
        return "CostCurveRangeRecord(id=%r, growth_type=%r, range_index=%r, start_step=%r, end_step=%r, add_multiplier=%r)" % (self.id, self.growth_type, self.range_index, self.start_step, self.end_step, self.add_multiplier)
...
class CostCurveRangeTable:
    ...
    def read(self, filename):
        ...
        records = [CostCurveRangeRecord() for _ in range(count)]
