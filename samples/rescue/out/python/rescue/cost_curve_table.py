...
class CostCurveRecord:
    ...
    def __repr__(self):
        return "CostCurveRecord(id=%r, name=%r, growth_type=%r, cost_type=%r, base_cost_value=%r)" % (self.id, self.name, self.growth_type, self.cost_type, self.base_cost_value)
...
class CostCurveTable:
    ...
    def read(self, filename):
        ...
        records = [CostCurveRecord() for _ in range(count)]
