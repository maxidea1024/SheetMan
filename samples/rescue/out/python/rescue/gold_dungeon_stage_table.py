...
class GoldDungeonStageTable:
    ...
    def read(self, filename):
        ...
        records = [GoldDungeonStageRecord() for _ in range(count)]
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "GoldDungeonStage.SpawnNextTime")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "GoldDungeonStage.AtkUpPercent")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "GoldDungeonStage.DefUpPercent")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "GoldDungeonStage.MHPUpPercent")
                for record in records:
