...
class OopartsDungeonRewardTable:
    ...
    def read(self, filename):
        ...
        records = [OopartsDungeonRewardRecord() for _ in range(count)]
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.Id")
                for record in records:
                    record.id = cursor.next_i32()
            elif column.tag == 2:
                sheetman.check_column(column, "OopartsDungeonReward.Name", sheetman.KIND_SCALAR, 1, (sheetman.ELEMENT_STRING,))
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.Name")
                for record in records:
                    record.name = cursor.next_string()
            elif column.tag == 3:
                sheetman.check_column(column, "OopartsDungeonReward.RewardName", sheetman.KIND_SCALAR, 1, (sheetman.ELEMENT_STRING,))
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardName")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardType1")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardValue1")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardType2")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.RewardValue2")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.IsFirstClear")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.FirstClearRewardType")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonReward.FirstClearRewardValue")
                for record in records:
