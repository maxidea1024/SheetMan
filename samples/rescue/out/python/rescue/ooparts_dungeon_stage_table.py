...
class OopartsDungeonStageTable:
    ...
    def read(self, filename):
        ...
        records = [OopartsDungeonStageRecord() for _ in range(count)]
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonStage.SpawnNextTime")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonStage.AtkUpPercent")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonStage.DefUpPercent")
                for record in records:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "OopartsDungeonStage.MHPUpPercent")
                for record in records:
