...
class SFXSoundRecord:
    ...
    def __repr__(self):
        return "SFXSoundRecord(id=%r, name=%r, category=%r, path=%r, preload_group=%r, description=%r)" % (self.id, self.name, self.category, self.path, self.preload_group, self.description)
...
class SFXSoundTable:
    ...
    def read(self, filename):
        ...
        records = [SFXSoundRecord() for _ in range(count)]
