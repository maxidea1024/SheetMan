...
class ShopInfoRecord:
    ...
    def __repr__(self):
        return "ShopInfoRecord(id=%r, name=%r, info_name=%r, shop_type=%r, condition_id=%r, sheet_name=%r, priority=%r, ui_path=%r, list_prefab_path=%r)" % (self.id, self.name, self.info_name, self.shop_type, self.condition_id, self.sheet_name, self.priority, self.ui_path, self.list_prefab_path)
...
class ShopInfoTable:
    ...
    def read(self, filename):
        ...
        records = [ShopInfoRecord() for _ in range(count)]
