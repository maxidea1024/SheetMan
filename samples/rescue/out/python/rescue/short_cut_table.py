...
class ShortCutRecord:
    ...
    def __repr__(self):
        return "ShortCutRecord(id=%r, name=%r, type_=%r, sub_index=%r, description=%r)" % (self.id, self.name, self.type_, self.sub_index, self.description)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = sheetman.ColumnCursor(reader, column, count, "ShortCut.Description")
                for record in records:
