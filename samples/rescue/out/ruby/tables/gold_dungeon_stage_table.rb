...
module Rescue
  ...
  class GoldDungeonStageTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { GoldDungeonStageRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.Id')
          records.each do |record|
            record.id = cursor.next_i32
          end
        when 2
          Sheetman.check_column(column, 'GoldDungeonStage.Name', Sheetman::KIND_SCALAR, 1, [Sheetman::ELEMENT_STRING])
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.Name')
          records.each do |record|
            record.name = cursor.next_string
          end
        when 3
          Sheetman.check_column(column, 'GoldDungeonStage.StageName', Sheetman::KIND_SCALAR, 1, [Sheetman::ELEMENT_STRING])
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.StageName')
          records.each do |record|
        ...
        when 4
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.DungeonType')
          records.each do |record|
        ...
        when 5
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.DungeonFloor')
          records.each do |record|
        ...
        when 6
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.TimeLimit')
          records.each do |record|
        ...
        when 9
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.SpawnPointCount')
          records.each do |record|
        ...
        when 10
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.SpawnMaxCount')
          records.each do |record|
        ...
        when 11
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.SpawnNextTime')
          records.each do |record|
        ...
        when 12
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.StageClearCount')
          records.each do |record|
        ...
        when 13
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.RecommendPower')
          records.each do |record|
        ...
        when 14
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.RewardID')
          records.each do |record|
        ...
        when 15
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.AtkUpPercent')
          records.each do |record|
        ...
        when 16
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.DefUpPercent')
          records.each do |record|
        ...
        when 17
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.MHPUpPercent')
          records.each do |record|
        ...
        when 18
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.DungeonImagePath')
          records.each do |record|
        ...
        when 19
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.MonsterImagePath')
          records.each do |record|
        ...
        when 20
          ...
          cursor = Sheetman::ColumnCursor.new(reader, column, count, 'GoldDungeonStage.AssetDataPath')
          records.each do |record|
