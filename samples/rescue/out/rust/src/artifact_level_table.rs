...
pub struct ArtifactLevelRecord {
    /// ArtifactLevelTable
    pub id: i32,
    /// 영문
    pub name: String,
...
impl ArtifactLevelRecord {
}

/// Every row of ArtifactLevel.
#[derive(Clone, Debug, Default)]
pub struct ArtifactLevelTable {
    records: Vec<ArtifactLevelRecord>,
    by_id: HashMap<i32, usize>,
}

impl ArtifactLevelTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[ArtifactLevelRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&ArtifactLevelRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&ArtifactLevelRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![ArtifactLevelRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                1 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactLevel.Id")?;
                ...
                2 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactLevel.Name")?;
                    for record in records.iter_mut() {
                ...
                3 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactLevel.NameKR")?;
                    for record in records.iter_mut() {
                ...
                4 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactLevel.Level")?;
                    for record in records.iter_mut() {
                ...
                5 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactLevel.CharacterEXP")?;
                    for record in records.iter_mut() {
                ...
                6 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactLevel.AccumulatedEXP")?;
                    for record in records.iter_mut() {
