...
impl ArtifactTable {
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&ArtifactRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&ArtifactRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![ArtifactRecord::default(); count];
