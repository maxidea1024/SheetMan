...
pub struct ArtifactTranscendenceRecord {
...
impl ArtifactTranscendenceRecord {
}

/// Every row of ArtifactTranscendence.
#[derive(Clone, Debug, Default)]
pub struct ArtifactTranscendenceTable {
    records: Vec<ArtifactTranscendenceRecord>,
    by_id: HashMap<i32, usize>,
}

impl ArtifactTranscendenceTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[ArtifactTranscendenceRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&ArtifactTranscendenceRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&ArtifactTranscendenceRecord> {
        self.by_id
            .get(&key)
            .map(|position| &self.records[*position])
            .ok_or_else(|| sheetman::Error::RecordNotFound {
                table: "ArtifactTranscendence",
                field: "Id",
                key: format!("{:?}", key),
            })
    }
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![ArtifactTranscendenceRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                1 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.Id")?;
                ...
                2 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.Name")?;
                    for record in records.iter_mut() {
                ...
                3 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.NameKR")?;
                    for record in records.iter_mut() {
                ...
                4 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.GradeType")?;
                    for record in records.iter_mut() {
                ...
                5 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.TranscendStep")?;
                    for record in records.iter_mut() {
                ...
                6 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.MaxLevel")?;
                    for record in records.iter_mut() {
                ...
                7 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.MaterialType")?;
                    for record in records.iter_mut() {
                ...
                8 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.MaterialCount")?;
                    for record in records.iter_mut() {
                ...
                9 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.PowerMultiplier")?;
                    for record in records.iter_mut() {
                ...
                10 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "ArtifactTranscendence.NextStepID")?;
                    for record in records.iter_mut() {
