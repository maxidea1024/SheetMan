...
impl BuffSelectRecord {
}

/// Every row of BuffSelect.
#[derive(Clone, Debug, Default)]
pub struct BuffSelectTable {
    records: Vec<BuffSelectRecord>,
    by_id: HashMap<i32, usize>,
}

impl BuffSelectTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[BuffSelectRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&BuffSelectRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&BuffSelectRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![BuffSelectRecord::default(); count];
