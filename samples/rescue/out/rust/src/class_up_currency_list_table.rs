...
pub struct ClassUpCurrencyListRecord {
    /// Currency_Table
    pub id: i32,
    /// 한글
    pub name: String,
...
impl ClassUpCurrencyListRecord {
}

/// Every row of ClassUpCurrencyList.
#[derive(Clone, Debug, Default)]
pub struct ClassUpCurrencyListTable {
    records: Vec<ClassUpCurrencyListRecord>,
    by_id: HashMap<i32, usize>,
}

impl ClassUpCurrencyListTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[ClassUpCurrencyListRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&ClassUpCurrencyListRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&ClassUpCurrencyListRecord> {
        self.by_id
            .get(&key)
            .map(|position| &self.records[*position])
            .ok_or_else(|| sheetman::Error::RecordNotFound {
                table: "ClassUpCurrencyList",
                field: "Id",
                key: format!("{:?}", key),
            })
    }
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![ClassUpCurrencyListRecord::default(); count];
