...
pub struct GachaArtifactInfoRecord {
...
impl GachaArtifactInfoRecord {
}

/// Every row of GachaArtifactInfo.
#[derive(Clone, Debug, Default)]
pub struct GachaArtifactInfoTable {
    records: Vec<GachaArtifactInfoRecord>,
    by_id: HashMap<i32, usize>,
}

impl GachaArtifactInfoTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[GachaArtifactInfoRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&GachaArtifactInfoRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&GachaArtifactInfoRecord> {
        self.by_id
            .get(&key)
            .map(|position| &self.records[*position])
            .ok_or_else(|| sheetman::Error::RecordNotFound {
                table: "GachaArtifactInfo",
                field: "Id",
                key: format!("{:?}", key),
            })
    }
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![GachaArtifactInfoRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                ...
                12 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "GachaArtifactInfo.EnableReset")?;
                    for record in records.iter_mut() {
                ...
                13 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "GachaArtifactInfo.IsSharedCounter")?;
                    for record in records.iter_mut() {
                ...
                16 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "GachaArtifactInfo.IsSingle")?;
                    for record in records.iter_mut() {
                ...
                17 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "GachaArtifactInfo.IsTen")?;
                    for record in records.iter_mut() {
                ...
                23 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "GachaArtifactInfo.EnableSkip")?;
                    for record in records.iter_mut() {
