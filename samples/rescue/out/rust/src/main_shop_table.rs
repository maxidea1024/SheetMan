...
#[derive(Clone, Debug, Default)]
pub struct MainShopTable {
    records: Vec<MainShopRecord>,
    by_id: HashMap<i32, usize>,
}

impl MainShopTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[MainShopRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&MainShopRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&MainShopRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![MainShopRecord::default(); count];
