...
pub struct SDAlchemyStepRecord {
    /// SDAlchemyStep_Table
    pub id: i32,
    /// 영문명
    pub name: String,
...
impl SDAlchemyStepRecord {
}

/// Every row of SDAlchemyStep.
#[derive(Clone, Debug, Default)]
pub struct SDAlchemyStepTable {
    records: Vec<SDAlchemyStepRecord>,
    by_id: HashMap<i32, usize>,
}

impl SDAlchemyStepTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[SDAlchemyStepRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&SDAlchemyStepRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&SDAlchemyStepRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![SDAlchemyStepRecord::default(); count];
