...
pub struct SDDungeonRewardRecord {
...
impl SDDungeonRewardRecord {
}

/// Every row of SDDungeonReward.
#[derive(Clone, Debug, Default)]
pub struct SDDungeonRewardTable {
    records: Vec<SDDungeonRewardRecord>,
    by_id: HashMap<i32, usize>,
}

impl SDDungeonRewardTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[SDDungeonRewardRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&SDDungeonRewardRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&SDDungeonRewardRecord> {
        self.by_id
            .get(&key)
            .map(|position| &self.records[*position])
            .ok_or_else(|| sheetman::Error::RecordNotFound {
                table: "SDDungeonReward",
                field: "Id",
                key: format!("{:?}", key),
            })
    }
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![SDDungeonRewardRecord::default(); count];
