...
#[derive(Clone, Debug, Default)]
pub struct ShopInfoTable {
    records: Vec<ShopInfoRecord>,
    by_id: HashMap<i32, usize>,
}

impl ShopInfoTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[ShopInfoRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&ShopInfoRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&ShopInfoRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![ShopInfoRecord::default(); count];
