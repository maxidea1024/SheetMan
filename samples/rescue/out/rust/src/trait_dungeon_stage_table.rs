...
pub struct TraitDungeonStageRecord {
...
impl TraitDungeonStageRecord {
}

/// Every row of TraitDungeonStage.
#[derive(Clone, Debug, Default)]
pub struct TraitDungeonStageTable {
    records: Vec<TraitDungeonStageRecord>,
    by_id: HashMap<i32, usize>,
}

impl TraitDungeonStageTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[TraitDungeonStageRecord] {
        &self.records
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&TraitDungeonStageRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> sheetman::Result<&TraitDungeonStageRecord> {
        self.by_id
            .get(&key)
            .map(|position| &self.records[*position])
            .ok_or_else(|| sheetman::Error::RecordNotFound {
                table: "TraitDungeonStage",
                field: "Id",
                key: format!("{:?}", key),
            })
    }
    ...
    pub fn read(&mut self, filename: &Path) -> sheetman::Result<()> {
        ...
        let mut records = vec![TraitDungeonStageRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                ...
                11 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "TraitDungeonStage.SpawnNextTime")?;
                    for record in records.iter_mut() {
                ...
                15 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "TraitDungeonStage.AtkUpPercent")?;
                    for record in records.iter_mut() {
                ...
                16 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "TraitDungeonStage.DefUpPercent")?;
                    for record in records.iter_mut() {
                ...
                17 => {
                    ...
                    let mut cursor = sheetman::ScbColumnCursor::new(&mut reader, column, header.row_count, "TraitDungeonStage.MHPUpPercent")?;
                    for record in records.iter_mut() {
