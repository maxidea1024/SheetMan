    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'BGMSound.Id')
          for (let i = 0; i < rowCount; ++i) {
        ...
        case 2:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'BGMSound.Name')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
        ...
        case 3:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'BGMSound.Path')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
        ...
        case 6:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'BGMSound.Description')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
