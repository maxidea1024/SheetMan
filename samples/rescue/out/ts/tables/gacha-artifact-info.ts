...
export class GachaArtifactInfoRecord {
  /** Default constructor */
  constructor() {
  }
...
// Generated from samples/rescue/GachaData.xlsx : GachaArtifactInfoTable : A1
export class GachaArtifactInfoTable {
  /** Default constructor. */
  constructor() {
  }

  /** All records. */
  public get records(): GachaArtifactInfoRecord[] { return this._records }
  private _records: GachaArtifactInfoRecord[] = []

  // Indexing by 'id'
  public get recordsById(): Map<number, GachaArtifactInfoRecord> { return this._recordsById }
  private _recordsById: Map<number, GachaArtifactInfoRecord> = new Map<number, GachaArtifactInfoRecord>()
   ...
   */
  public findById(key: number): GachaArtifactInfoRecord | undefined {
   ...
   */
  public getByIdOrThrow(key: number): GachaArtifactInfoRecord {
    const found = this._recordsById.get(key)
    if (!found)
      throw new Error(`There is no record in table "GachaArtifactInfo" that corresponds to field "id" value ${key}`)
  ...
  private readFromJson(json: string): void {
    ...
    const records: GachaArtifactInfoRecord[] = []

    if (this.isCompactRowFormatted(dataRows)) {
      for (const dataRow of dataRows) {
        const record = new GachaArtifactInfoRecord()
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (let i = 0; i < rowCount; ++i)
      records.push(new GachaArtifactInfoRecord())
   ...
   */
  private publish(records: GachaArtifactInfoRecord[]): void {
    const recordsById = new Map<number, GachaArtifactInfoRecord>()
