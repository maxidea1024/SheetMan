...
export class SDDungeonInfoRecord {
  /** Default constructor */
  constructor() {
  }
...
// Generated from samples/rescue/SD_Contens.xlsx : SDDungeonInfoTable : A1
export class SDDungeonInfoTable {
  /** Default constructor. */
  constructor() {
  }

  /** All records. */
  public get records(): SDDungeonInfoRecord[] { return this._records }
  private _records: SDDungeonInfoRecord[] = []

  // Indexing by 'id'
  public get recordsById(): Map<number, SDDungeonInfoRecord> { return this._recordsById }
  private _recordsById: Map<number, SDDungeonInfoRecord> = new Map<number, SDDungeonInfoRecord>()
   ...
   */
  public findById(key: number): SDDungeonInfoRecord | undefined {
   ...
   */
  public getByIdOrThrow(key: number): SDDungeonInfoRecord {
    const found = this._recordsById.get(key)
    if (!found)
      throw new Error(`There is no record in table "SDDungeonInfo" that corresponds to field "id" value ${key}`)
  ...
  private readFromJson(json: string): void {
    ...
    const records: SDDungeonInfoRecord[] = []

    if (this.isCompactRowFormatted(dataRows)) {
      for (const dataRow of dataRows) {
        const record = new SDDungeonInfoRecord()
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (let i = 0; i < rowCount; ++i)
      records.push(new SDDungeonInfoRecord())
   ...
   */
  private publish(records: SDDungeonInfoRecord[]): void {
    const recordsById = new Map<number, SDDungeonInfoRecord>()
