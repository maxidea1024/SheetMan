    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        ...
        case 4:
          ...
          break
        case 5:
          sheetman.checkColumn(column, 'Stage.SpawnIds', sheetman.KIND_VAR_ARRAY, 0, [sheetman.ELEMENT_I32, sheetman.ELEMENT_VARINT])
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
        ...
        case 9:
          ...
          break
        case 10:
          sheetman.checkColumn(column, 'Stage.BossID', sheetman.KIND_VAR_ARRAY, 0, [sheetman.ELEMENT_I32, sheetman.ELEMENT_VARINT])
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
            const elementCount = reader.readCounter32()
            record._bossID = []
