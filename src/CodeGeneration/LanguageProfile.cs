...
public sealed class LanguageProfile
{
    ...
    public static readonly LanguageProfile C = new LanguageProfile(
        ...
        new Dictionary<ValueType, string>
        {
            ...
            { ValueType.Int32, "sm_read_i32_as(reader, column->element, {0})" },
            { ValueType.Int64, "sm_read_i64_as(reader, column->element, {0})" },
            { ValueType.Float, "sm_read_float(reader, {0})" },
            { ValueType.Double, "sm_read_f64_as(reader, column->element, {0})" },
