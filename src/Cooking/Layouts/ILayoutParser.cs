...
/// <see cref="SheetManLayoutAttribute"/> on it.
///
...
/// </summary>
/// <remarks>
/// The same shape as <see cref="Sources.SheetManSourceAttribute"/> and
/// <see cref="Targets.SheetManTargetAttribute"/>, so there is one idea to learn rather than
/// three.
/// </remarks>
[AttributeUsage(AttributeTargets.Class, Inherited = false, AllowMultiple = false)]
public sealed class SheetManLayoutAttribute : Attribute
{
    public SheetManLayoutAttribute(string id)
    {
