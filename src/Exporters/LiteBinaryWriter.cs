...
/// <summary>
/// Writes the LiteBinary format that <see cref="BinaryExporter"/> produces.
///
...
/// </summary>
public sealed class LiteBinaryWriter
{
    private byte[] _buffer;
    private int _length;

    public LiteBinaryWriter(int initialCapacity = 64 * 1024)
    {
