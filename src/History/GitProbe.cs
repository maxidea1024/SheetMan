...
namespace SheetMan.History
{
    ...
    internal static class GitProbe
    {
        ...
        public static bool TryHead(string directory, out string hash)
        ...
        /// </summary>
        public static bool TryBranch(string directory, out string branch)
        {
        ...
        public static bool TryDescribe(string directory, string commit, out GitCommit described)
        {
            described = null;
        ...
        public static bool TryRun(string directory, out string output, params string[] args)
        {
            output = null;
    ...
    {
        public GitCommit(string hash, string authorName, string authorEmail, DateTimeOffset? committedAt, string subject)
        {
            Hash = hash;
