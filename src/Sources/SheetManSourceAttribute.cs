...
/// <summary>
/// Marks a class as a SheetMan input source and gives the registry what it needs to
/// drive it.
///
/// The counterpart of <see cref="Targets.SheetManTargetAttribute"/>, and simpler:
...
public sealed class SheetManSourceAttribute : Attribute
{
    public SheetManSourceAttribute(string id, string section)
    {
