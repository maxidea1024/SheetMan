...
public static class DatabaseFixture
{
    ...
    /// </summary>
    public const string Password = "sheetman-test";

    public const string PasswordVariable = "SHEETMAN_TEST_DB_PASSWORD";
    public const string MySqlPortVariable = "SHEETMAN_TEST_MYSQL_PORT";
    public const string PostgresPortVariable = "SHEETMAN_TEST_POSTGRES_PORT";
    public const string MongoPortVariable = "SHEETMAN_TEST_MONGO_PORT";
    public const string RedisPortVariable = "SHEETMAN_TEST_REDIS_PORT";
    ...
    public static string MySqlConnectionString =>
        $"Server=127.0.0.1;Port={Port(MySqlPortVariable)};Database=sheetman_test;Uid=root;Pwd={Password}";

    public static string PostgreSqlConnectionString =>
        $"Host=127.0.0.1;Port={Port(PostgresPortVariable)};Database=sheetman_test;Username=postgres;Password={Password}";

    public static string MongoConnectionString =>
        $"mongodb://127.0.0.1:{Port(MongoPortVariable)}/sheetman_test";
