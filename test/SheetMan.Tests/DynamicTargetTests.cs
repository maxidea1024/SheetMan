...
namespace SheetMan.Tests
{
    ...
    public class DynamicTargetTests
    {
        ...
        {
            var result = SheetManRunner.Convert("core-dynamic");
        ...
        {
            var result = SheetManRunner.Convert("targets-unknown-type");
        ...
        {
            var result = SheetManRunner.Convert("targets-missing-type");
        ...
        {
            var result = SheetManRunner.Convert("targets-unknown-setting");
