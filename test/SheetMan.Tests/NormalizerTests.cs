...
namespace SheetMan.Tests
{
    ...
    public class NormalizerTests
    {
        private const string HtmlFooter =
            "<div>x</div>\n<br><h4>This file was created at 2026-08-03 12:05:46 by jhseo</h4></body></html>\n";
        ...
        [Fact]
        public void The_clock_and_the_user_name_are_masked_out_of_a_page()
        {
            string masked = OutputNormalizer.Normalize("html/index.html", HtmlFooter);

            Assert.DoesNotContain("jhseo", masked);
