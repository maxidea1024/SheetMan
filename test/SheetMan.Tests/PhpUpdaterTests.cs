...
///
/// The file under test is the shipped one - lib/php/sheetman/SheetManUpdater.php -
...
public class PhpUpdaterTests : IDisposable
{
    ...
    private string Stage()
    {
        ...
        File.Copy(Path.Combine(RepoLayout.Root, "lib", "php", "sheetman", "SheetManUpdater.php"),
                  Path.Combine(work, "sheetman", "SheetManUpdater.php"), overwrite: true);
