...
public class SchemaBaselineTests
{
  ...
  ""Sources"": {{
""Xlsx"": [ {{ ""Path"": ""test/fixtures/xlsx/{xlsxScenario}"", ""FileExtensionPatterns"": "".xlsx"" }} ]
  }},
  ""Exports"": {{
""Binary"": [
  {{
    ...
    private static RunResult Convert(string recipe)
        => SheetManRunner.Invoke("--recipe", recipe, "--debug");
  ...
  ""Sources"": {{
""Xlsx"": [ {{ ""Path"": ""test/fixtures/xlsx/evolution-v1"", ""FileExtensionPatterns"": "".xlsx"" }} ]
  }},
  ""Exports"": {{
