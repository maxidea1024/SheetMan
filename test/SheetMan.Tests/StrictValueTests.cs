...
namespace SheetMan.Tests
{
    ...
    public class StrictValueTests
    {
        ...
        {
            var result = SheetManRunner.Convert("strict-values");
        ...
        {
            var result = SheetManRunner.Convert("double-star");
        ...
        {
            var result = SheetManRunner.Convert("formula-error");
        ...
        {
            var result = SheetManRunner.Convert("enum-by-value");
