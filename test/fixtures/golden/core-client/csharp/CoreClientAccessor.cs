...
namespace SheetMan.Fixtures.Core.Client
{
    ...
    public partial class ItemTable
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name", "CategoryId", "GradeField", "SkillField", "Description" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            var result = new List<object[]>();
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name, r.CategoryId, r.GradeField, r.SkillField, r.Description });
    ...
    public partial class ArrayTypesTable
    {
        ...
        public partial class Record
        {
            ...
            private global::SheetMan.Fixtures.Core.Client.Grade[] _grades = System.Array.Empty<global::SheetMan.Fixtures.Core.Client.Grade>();
            ...
            public Task ReadAsync(LiteBinaryReader reader)
            {
                ...
                _grades = new global::SheetMan.Fixtures.Core.Client.Grade[Grades_count];
                for (int i = 0; i < Grades_count; ++i)
                {
                    reader.ReadOptimalInt32(out tempEnumInt);
                    _grades[i] = (global::SheetMan.Fixtures.Core.Client.Grade)tempEnumInt;
                }
