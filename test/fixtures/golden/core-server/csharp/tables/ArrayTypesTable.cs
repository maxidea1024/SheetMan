...
namespace SheetMan.Fixtures.Core.Server
{
    ...
    public partial class ArrayTypesTable
    {
        ...
        public partial class Record
        {
            ...
            internal global::SheetMan.Fixtures.Core.Server.Grade[] _grades = System.Array.Empty<global::SheetMan.Fixtures.Core.Server.Grade>();
                ...
                switch (column.Tag)
                {
                    ...
                    case 5:
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            reader.TryReadCounter32(out int elementCount);
                            record._grades = new global::SheetMan.Fixtures.Core.Server.Grade[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                reader.ReadOptimalInt32(out tempEnumInt);
                                record._grades[j] = (global::SheetMan.Fixtures.Core.Server.Grade)tempEnumInt;
                            }
                        }
                        break;
