            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 4:
                        ...
                        {
                            var record = records[i];
                            record._gradeField = (global::SheetMan.Fixtures.Core.Server.Grade)cursor.NextI32();
                        }
                        break;
                    ...
                    case 5:
                        ...
                        {
                            var record = records[i];
                            record._skillField = (global::SheetMan.Fixtures.Core.Server.SkillType)cursor.NextI32();
                        }
                        break;
