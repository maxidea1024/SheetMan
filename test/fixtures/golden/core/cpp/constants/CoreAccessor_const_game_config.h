...
#ifndef SHEETMAN_GENERATED_COREACCESSOR_CONST_GAME_CONFIG_H
#define SHEETMAN_GENERATED_COREACCESSOR_CONST_GAME_CONFIG_H
...
struct GameConfig {
  ...
  static inline const sheetman::DateTime SeasonStart = sheetman::from_net_ticks(637817220000000000LL);
  /// length of one round
...
#endif  // SHEETMAN_GENERATED_COREACCESSOR_CONST_GAME_CONFIG_H
