...
namespace SheetMan.Fixtures.Core
{
    ...
    public partial class ItemTable
    {
        ...
        public partial class Record
        {
            ...
            internal global::SheetMan.Fixtures.Core.Grade _gradeField;
            internal global::SheetMan.Fixtures.Core.SkillType _skillField;
                ...
                switch (column.Tag)
                {
                    ...
                    case 4:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._gradeField = (global::SheetMan.Fixtures.Core.Grade)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 5:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._skillField = (global::SheetMan.Fixtures.Core.SkillType)value;
                            } while (--n > 0);
                        }
                        break;
