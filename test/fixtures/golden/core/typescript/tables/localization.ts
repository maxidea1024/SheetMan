    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'Localization.Index')
          for (let i = 0; i < rowCount; ++i) {
        ...
        case 2:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'Localization.Key')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
