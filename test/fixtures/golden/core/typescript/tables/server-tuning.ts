...
export class ServerTuningTable {
   ...
   */
  public findByIndex(key: number): ServerTuningRecord | undefined {
   ...
   */
  public getByIndexOrThrow(key: number): ServerTuningRecord {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'ServerTuning.Index')
          for (let i = 0; i < rowCount; ++i) {
        ...
        case 2:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'ServerTuning.Key')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
        ...
        case 3:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'ServerTuning.Amount')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
