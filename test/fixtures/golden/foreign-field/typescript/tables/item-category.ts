...
export class ItemCategoryTable {
   ...
   */
  public findByIndex(key: number): ItemCategoryRecord | undefined {
   ...
   */
  public getByIndexOrThrow(key: number): ItemCategoryRecord {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'ItemCategory.Index')
          for (let i = 0; i < rowCount; ++i) {
        ...
        case 2:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'ItemCategory.Name')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
        ...
        case 3:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'ItemCategory.Description')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
