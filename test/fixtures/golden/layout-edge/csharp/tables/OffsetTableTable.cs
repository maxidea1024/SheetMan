    ...
    public partial class OffsetTableTable
    {
        ...
        public Task ReadAsync(ScbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        ScbTable.CheckColumn(column, "OffsetTable.Index", ScbTable.KindScalar, 1, ScbTable.ElementI32, ScbTable.ElementVarint);
                        cursor = new ScbColumnCursor(reader, column, count, "OffsetTable.Index");
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        ScbTable.CheckColumn(column, "OffsetTable.Name", ScbTable.KindScalar, 1, ScbTable.ElementString);
                        cursor = new ScbColumnCursor(reader, column, count, "OffsetTable.Name");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        ScbTable.CheckColumn(column, "OffsetTable.Value", ScbTable.KindScalar, 1, ScbTable.ElementI32, ScbTable.ElementVarint);
                        cursor = new ScbColumnCursor(reader, column, count, "OffsetTable.Value");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            record._value = cursor.NextI32();
                        }
                        break;
