    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'OffsetTable.Index')
          for (let i = 0; i < rowCount; ++i) {
        ...
        case 2:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'OffsetTable.Name')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
        ...
        case 3:
          ...
          cursor = new sheetman.ScbColumnCursor(reader, column, rowCount, 'OffsetTable.Value')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
