...
namespace SheetMan.Fixtures.Nested
{
    /// <summary>
    ...
    public partial class LoadoutTable
    {
        ...
        public partial class Record
        {
            ...
            private static SlotEntry[] NewSlotEntryArray()
            {
                var result = new SlotEntry[Slot_N];
            ...
            internal SlotEntry[] _slot = NewSlotEntryArray();
        ...
        public Record GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out Record record))
                throw new SheetManException($"There is no record in table `Loadout` that corresponds to field `Index` value {key}");
        ...
        public Task ReadAsync(ScbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        ScbTable.CheckColumn(column, "Loadout.Index", ScbTable.KindScalar, 1, ScbTable.ElementI32, ScbTable.ElementVarint);
                        cursor = new ScbColumnCursor(reader, column, count, "Loadout.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        ScbTable.CheckColumn(column, "Loadout.Name", ScbTable.KindScalar, 1, ScbTable.ElementString);
                        cursor = new ScbColumnCursor(reader, column, count, "Loadout.Name");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        ScbTable.CheckColumn(column, "Loadout.Pos.X", ScbTable.KindScalar, 1, ScbTable.ElementF32);
                        cursor = new ScbColumnCursor(reader, column, count, "Loadout.Pos.X");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 4:
                        ScbTable.CheckColumn(column, "Loadout.Pos.Y", ScbTable.KindScalar, 1, ScbTable.ElementF32);
                        cursor = new ScbColumnCursor(reader, column, count, "Loadout.Pos.Y");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        ScbTable.CheckColumn(column, "Loadout.Slot.Id", ScbTable.KindFixedArray, 2, ScbTable.ElementI32, ScbTable.ElementVarint);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 6:
                        ScbTable.CheckColumn(column, "Loadout.Slot.Label", ScbTable.KindFixedArray, 2, ScbTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            for (int j = 0; j < Record.Slot_N; ++j)
                            {
                                reader.Read(out record._slot[j].Label);
                            }
                        }
                        break;

                    case 7:
                        ScbTable.CheckColumn(column, "Loadout.Note", ScbTable.KindScalar, 1, ScbTable.ElementString);
                        cursor = new ScbColumnCursor(reader, column, count, "Loadout.Note");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 8:
                        ScbTable.CheckColumn(column, "Loadout.Tag_array", ScbTable.KindFixedArray, 2, ScbTable.ElementString);
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            ...
                            {
                                reader.Read(out record._tagArray[j]);
                            }
                        }
                        break;
