...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                ["TestFieldTypes"] = Tables.TestFieldTypes.Records.Select(r => new Dictionary<string, object>
                {
                    ["index"] = r.Index,
                ...
                ["ArrayTypes"] = Tables.ArrayTypes.Records.Select(r => new Dictionary<string, object>
                {
                    ["index"] = r.Index,
                    ["tags"] = r.Tags,
                    ["costs"] = r.Costs,
                ...
                ["Item"] = Tables.Item.Records.Select(r => new Dictionary<string, object>
                {
                    ["index"] = r.Index,
                    ["name"] = r.Name,
