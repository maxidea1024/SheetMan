 ...
 *
 * The updater under test is the shipped one - lib/java/sheetman/SheetManUpdater.java -
...
public final class Main {
    public static void main(String[] args) {
        ...
        SheetManUpdater.Result result = SheetManUpdater.update(args[0], cache, options);
