 ...
 *
 * The updater under test is the shipped one - lib/php/sheetman/SheetManUpdater.php -
 * copied in beside this file and required exactly as a consumer would require it.
 */

declare(strict_types=1);

require_once __DIR__ . '/sheetman/SheetManUpdater.php';
...
$result = SheetManUpdater::update($argv[1], $argv[2], $options);
