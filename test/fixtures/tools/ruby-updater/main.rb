...
#
# The updater under test is the shipped one - lib/ruby/sheetman/updater.rb - copied in
# beside this file and required exactly as a consumer would require it.

require 'json'
require_relative 'sheetman/updater'
