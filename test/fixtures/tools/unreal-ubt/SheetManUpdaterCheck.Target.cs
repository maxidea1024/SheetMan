...
public class SheetManUpdaterCheckTarget : TargetRules
{
	public SheetManUpdaterCheckTarget(TargetInfo Target) : base(Target)
	{
		Type = TargetType.Program;
		LinkType = TargetLinkType.Monolithic;
		LaunchModuleName = "SheetManUpdaterCheck";
